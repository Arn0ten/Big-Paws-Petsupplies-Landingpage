...
>
  ...
  <div className="flex items-start space-x-4">
    ...
    <div>
      ...
      <p className="text-muted-foreground">
        <a href="https://www.google.com/maps/@7.4460297,125.8037527,0a,81.7y,20.93h,88.06t/data=!3m4!1e1!3m2!1syoMuKL9gYTS0UI7oEBSs2w!2e0?source=apiv3" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
  ...
  <div className="flex items-start space-x-4">
    <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg"
      alt="WhatsApp" className="w-6 h-6 flex-shrink-0 mt-1" />
    <div>
  ...
  <div className="flex items-start space-x-4">
    <img src="https://upload.wikimedia.org/wikipedia/commons/7/7e/Gmail_icon_(2020).svg"
      alt="Gmail" className="w-6 h-6 flex-shrink-0 mt-1" />
    <div>
  ...
  <div className="flex items-start space-x-4">
    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 flex-shrink-0 mt-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
